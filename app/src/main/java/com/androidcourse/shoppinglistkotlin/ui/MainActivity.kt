...
class MainActivity : AppCompatActivity() {
    ...
    private fun getShoppingListFromDatabase() {
        ...
        //new coroutine is launched on the Main Dispatcher with the launch method from CoroutineScope
        mainScope.launch {

            //Now getting the products from the repository we need to use the IO dispatcher.
            // Because this is a different dispatcher we need to use withContext
            val shoppingList = withContext(Dispatchers.IO) {
                productRepository.getAllProducts()
            }

            //When the product list is received from the database we can resume on the main thread
            //to populate the shopping list and notify the adapter about the data set changes.
    ...
    //Deletes the shopping list using a coroutine
